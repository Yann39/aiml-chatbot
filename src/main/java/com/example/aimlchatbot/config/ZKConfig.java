package com.example.aimlchatbot.config;
...
public class ZKConfig {
    ...
    private static final String BOOTSTRAP_CSS = "https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/css/bootstrap.min.css";
    private static final String LOBSTER_FONT = "https://fonts.googleapis.com/css?family=Istok+Web:400,400italic,700,700italic|Lobster:400&subset=latin";
    ...
    public static class ZKCommonConfig {
        ...
        public void initCommonProperties() {
            ...
            WebApps.getCurrent().getConfiguration().addThemeURI(LOBSTER_FONT);
